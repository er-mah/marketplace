...
export const CompleteAdditionalInfoSchema = Yup.object().shape({
  ...
  user_is_agency_representative: Yup.boolean().required(
  ...
  user_agency_id: Yup.string().required("La agencia es requerida"),
  ...
  agency_zip_code: Yup.string().required("El código postal es requerido"),
});
