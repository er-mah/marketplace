...
export const dynamicEmailHtmlUtils = {
  ...
  generateAccountRecoveryEmailHtml: () => {
    return handlebars.compile(`<html>
<head>
  <meta charset="utf-8" />
  <meta http-equiv="x-ua-compatible" content="ie=edge" />
  ...
  <td align="center" bgcolor="#326f78">
    ...
    >
      ...
      <tr>
        ...
        >
          <p style="margin: 0">
            Presiona el botón de abajo para ir a la pagina de recuperacion de contraseña. Si no creaste una cuenta con
            <a href="https://techmo.global">TechMo</a>, puedes desestimar
            este correo electrónico.
          </p>
        </td>
...
export const dynamicPlainTextEmailUtils = {
  ...
  generatedAccountRecoveryEmail: (data) => {
    return `¡Hola, ${data.user.first_name + " " + data.user.last_name}!
    Para recuperar tu contraseña por favor haz clic en este link: ${
      data.verificationUrl
    }
    El equipo de TechMo
    `;
